...
-- Create default user "elemento" with password "elemento"
INSERT INTO guacamole_entity (name, type) VALUES ('elemento', 'USER');
INSERT INTO guacamole_user (entity_id, password_hash, password_salt, password_date)
SELECT
    entity_id,
    '\x2b076f900d6f7013054c9cf1a42ed961307ce68f2afdad35e71855e909208d3a',  -- 'elemento'
    '\xd7059e7b8271ed4201fa8b20976fdf9728088e27d14cf344e8def3035df55937',
    CURRENT_TIMESTAMP
FROM guacamole_entity WHERE name = 'elemento' AND guacamole_entity.type = 'USER';
...
FROM (
    VALUES
        ('elemento', 'CREATE_CONNECTION'),
        ('elemento', 'CREATE_CONNECTION_GROUP'),
        ('elemento', 'CREATE_SHARING_PROFILE'),
        ('elemento', 'CREATE_USER'),
        ('elemento', 'CREATE_USER_GROUP'),
        ('elemento', 'ADMINISTER')
...
FROM (
    VALUES
        ('elemento', 'elemento', 'READ'),
        ('elemento', 'elemento', 'UPDATE'),
        ('elemento', 'elemento', 'ADMINISTER')
